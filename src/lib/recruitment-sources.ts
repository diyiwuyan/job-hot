...
export const RECRUITMENT_SOURCES: RecruitmentSource[] = [
  ...
  { id: 'picrew-campus2027', name: 'Picrew Campus2027 官方校招精选', kind: 'campus-info', url: 'https://github.com/Picrew/Campus2027', focus: '2027 届互联网、AI、机器人、芯片与量化校招', coverage: '逐条标注官方申请页、核验日期与证据等级', category: 'internet', verifiedAt: '2026-09-09' },
];
...
export const DIRECTORY_RECRUITMENT_SOURCES = RECRUITMENT_SOURCES.filter(source =>
  !['yingjiesheng', 'nowcoder', 'deepoffer', 'guopin', 'campus2027-github', 'picrew-campus2027'].includes(source.id)
);
